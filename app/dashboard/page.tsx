...
export default function HomeV2Page() {
  ...
  // Both status cards navigate as a whole, so their click and keyboard paths
  // share one handler each rather than repeating the analytics call inline.
  function openLogs() {
  ...
  function openMedications() {
    captureEvent("medications_entry_clicked", { source: "home_v2_reminders" });
    ...
    <div className="db-page">
      ...
      <main className="db-main homev2-main">
        ...
        <section className="homev2-status-row">
          <article
            className="homev2-status-card is-clickable"
            role="link"
            tabIndex={0}
            aria-label="Logging status — open your logs"
            onClick={openLogs}
            onKeyDown={(event) => {
          ...
          >
            <div className="homev2-status-head">
              ...
              <CaretRight size={14} weight="bold" className="homev2-status-caret" />
            </div>
          ...
          <article
            className="homev2-status-card homev2-reminder-card is-clickable"
            role="link"
            tabIndex={0}
            aria-label="Next reminders — open medications"
          ...
          >
            ...
            {/* The whole card is the link now, so this stays as a visual cue
                rather than a second interactive element nested inside it. */}
            <span className="homev2-status-link" aria-hidden="true">
